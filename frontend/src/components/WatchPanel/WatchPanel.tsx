  ...
  return (
    <div className="watch-panel">
      ...
      {loading ? (
        ...
        <EmptyState
          icon={<EyeIcon size={44} color="var(--text-muted)" />}
          title="No watches yet"
          message="Enter a target above to start monitoring. TRINETRA will re-scan it at the configured interval and alert you of changes."
          ctaLabel="Add your first watch"
          ctaIcon={<EyeIcon size={13} />}
          onCta={() => document.getElementById('watch-target-input')?.focus()}
        />
      ) : (
